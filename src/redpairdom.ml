module Make(C1 : Sigs.LATTICE)(C2 : Sigs.LATTICE)(*(Str : sig val prefix : string end)*) =
struct
  ...
  let narrowing (c1,c2) (d1,d2) = pair (C1.narrowing c1 d1, C2.narrowing c2 d2)
  ...
  let fpprint fmt (c1,c2) =
    begin
    (*  Format.fprintf fmt "%s(" Str.prefix; *)
      Format.fprintf fmt "(";
      C1.fpprint fmt c1;
      Format.fprintf fmt ", ";
      C2.fpprint fmt c2;
...
module MakeExt(C1 : Sigs.EXTLATTICE)(C2 : Sigs.EXTLATTICE)(*(Str : sig val prefix : string end)*) =
struct
